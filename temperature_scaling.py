...
class _ECELoss(nn.Module):
    ...
    def forward(self, logits, labels):
        ...
        for bin_lower, bin_upper in zip(self.bin_lowers, self.bin_uppers):
            ...
            in_bin = confidences.gt(bin_lower.item()) * confidences.le(bin_upper.item()) # gt: greater than, le: less than or equal to, return 0 or 1, 
            # final return the index of samples belong to this bin
            prop_in_bin = in_bin.float().mean() # in_bin numbers / total numbers
